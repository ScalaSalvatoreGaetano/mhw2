...
function seleziona_risposta(event)
{
    ...
    sel = !sel;
    if(sel){
        seleziona.classList.add("selezione");
        img.src = checked;
    } else {
        seleziona.classList.remove("selezione");
        img.src = unchecked;
    }
}
...
for(let i of box){
    i.addEventListener("click", seleziona_risposta);
}


function rimuovi_selezione(){
    const box = document.querySelectorAll("");
}


/*
la mappa proveniente da "constants.js" non viene letta
*/
...
function random()
{
    const indice_mappa = 9;
    let random_indice = Math.floor(Math.random()*indice_mappa);
    ...
    const ricomincia = document.querySelector(".ricomincia");
        ...
        if(random_indice === 1){
            ...
            contenuto.textContent = RESULTS_MAP['blep'].contents;
            ...
            ricomincia.classList.remove("hidden");

            console.log(RESULTS_MAP['blep'].title);
            console.log(RESULTS_MAP['blep'].contents);
            ...
            console.log(RESULTS_MAP['burger'].title);
            console.log(RESULTS_MAP['burger'].contents);
            ...
            console.log(RESULTS_MAP['cart'].title);
            console.log(RESULTS_MAP['cart'].contents);

        } else if(random_indice === 4){//dopey
            titolo.textContent = RESULTS_MAP['blep'].title;
            contenuto.textContent = RESULTS_MAP['blep'].contents;
            ...
            console.log(RESULTS_MAP['dopey'].title);
            console.log(RESULTS_MAP['dopey'].contents);
        } else if(random_indice === 5){//happy
            titolo.textContent = RESULTS_MAP['blep'].title;
            contenuto.textContent = RESULTS_MAP['blep'].contents;
            ...
            console.log(RESULTS_MAP['happy'].title);
            console.log(RESULTS_MAP['happy'].contents);
            
        } else if(random_indice === 6){//nerd
            titolo.textContent = RESULTS_MAP['blep'].title;
            contenuto.textContent = RESULTS_MAP['blep'].contents;
            ...
            console.log(RESULTS_MAP['nerd'].title);
            console.log(RESULTS_MAP['nerd'].contents);
        } else if(random_indice === 7){//shy
            titolo.textContent = RESULTS_MAP['blep'].title;
            contenuto.textContent = RESULTS_MAP['blep'].contents;
            ...
            console.log(RESULTS_MAP['shy'].title);
            console.log(RESULTS_MAP['shy'].contents);

        } else if(random_indice === 8){ //sleeping
            titolo.textContent = RESULTS_MAP['blep'].title;
            contenuto.textContent = RESULTS_MAP['blep'].contents;
            ...
            console.log(RESULTS_MAP['sleeping'].title);
            console.log(RESULTS_MAP['sleeping'].contents);
            ...
            console.log(RESULTS_MAP['sleepy'].title);
            console.log(RESULTS_MAP['sleepy'].contents);
        }
}



const click = document.querySelector("#avvia");
